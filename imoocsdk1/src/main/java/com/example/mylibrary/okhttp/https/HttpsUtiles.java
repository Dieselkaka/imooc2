 ...
 */
package com.example.mylibrary.okhttp.https;
...
/**
 * 项目名:    imooc2
 * 包名:      com.example.mylibrary.okhttp.https
 * 文件名:    HttpsUtiles
 * 创建者:    Diesel
 * 创建时间:     2017/11/13 18:48
 * 描述:      TODO
 * 修改时间:
 * 修改备注:
 */
public class HttpsUtiles {
    ...
    public static SSLSocketFactory getSslSocketFactory()
    {
        ...
        try
        {
            sslContext = SSLContext.getInstance("SSL");//算法与服务器保持一致
