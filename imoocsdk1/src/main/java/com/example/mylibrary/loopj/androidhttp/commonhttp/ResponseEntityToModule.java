 ...
 */
package com.example.mylibrary.loopj.androidhttp.commonhttp;
...
/**
 * 项目名:    imooc2
 * 包名:      com.example.mylibrary.loopj.androidhttp.commonhttp
 * 文件名:    ResponseEntityToModule
 * 创建者:    Diesel
 * 创建时间:     2017/11/16 20:10
 * 描述:      递归ORM映射
 * 修改时间:
 * 修改备注:
 */
